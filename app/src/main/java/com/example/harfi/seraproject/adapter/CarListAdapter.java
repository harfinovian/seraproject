package com.example.harfi.seraproject.adapter;
...
public abstract class CarListAdapter<T, VH extends RecyclerView.ViewHolder> extends RecyclerView.Adapter<VH> {
    ...
    public CarListAdapter(int mLayout, Class<VH> mViewHolderClass, Class<T> mModelClass, List<T> mData) {
